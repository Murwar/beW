                    ...
                    <div className={'rectangle_new_hotel'}>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input className={'input_data_name'} type="text" name="hotel_name"
                                           placeholder="введите название объекта" size="50" maxlength="50"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input className={'input_data_adress'} type="text" name="hotel_adress"
                                           placeholder="введите адрес объекта" size="100" maxlength="100"></input>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input className={'input_data_rooms'} type="text" name="hotel_rooms"
                                           placeholder="введите количество номеров" size="5" maxlength="3"></input>
                                </td>
                            </tr>
